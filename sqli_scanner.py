...
# -*- coding: utf-8 -*-
"""
SQL Injection Scanner (Crawling & Target Testing Modes)
Author: Ian Lusule
"""
...
class SQLiScanner:
    """SQL Injection Scanner with crawling and direct testing modes"""

    def __init__(self, threads=10, timeout=10, user_agent=None, output_file=None):
        self.threads = threads
        self.timeout = timeout
        self.user_agent = user_agent or 'SQLiScanner/1.0'
    ...
    def test_url(self, url):
        """
        Tests a single URL for SQL injection vulnerabilities
    ...
    def is_sql_injection(self, response):
        """
        Checks if response indicates SQL injection vulnerability
        ...
        if response.elapsed.total_seconds() > self.timeout * 0.5:
            return True
    ...
    def crawl_and_test(self, start_url, max_depth):
        """
        Crawls website and tests URLs for SQLi vulnerabilities
...
"""
  ...
  _____  _____ _      _     ___
 / ____|/ ____| |    (_)   |__ \
| (___ | (___ | |     _ _ __  ) |___  ___ _ __
 \___ \ \___ \| |    | | '_ \| / / _ \/ _ \ '__|
 ____) |____) | |____| | | | |/ /  __/  __/ |
|_____/|_____/|______|_|_| |_|____\___|\___|_|
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='SQL Injection Scanner - Crawling & Target Testing Modes',
        epilog='Examples:\n'
               '  Target Testing: python sqli_scanner.py -f urls.txt -Tt\n'
               '  Crawling Mode: python sqli_scanner.py -u http://example.com -d 2',
        add_help=False
    )
